...
inline bool appartiene_a_segmento(Vector3d& origin, Vector3d& end, Vector3d& pto, double toll){
...
inline bool pto_unico(Vector3d& pto, vector<Vector3d>& punti, double toll, unsigned int& id){
